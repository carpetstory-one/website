...
export function Doors() {
  ...
  return (
    <section className="doors" id="doors" style={{ padding: 0 } as React.CSSProperties}>
      <motion.div
      ...
      >
        ...
        <Link href="/inquiry" className="door-cta link magnetic">
          {t('leftCta')}
        </Link>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <Link href="/trade" className="door-cta link magnetic">
          {t('rightCta')}
        </Link>
      </motion.div>
    </section>
